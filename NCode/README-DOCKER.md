...
- `SERVER_CONTEXT_PATH`: Ruta del contexto (por defecto: /NCode)
...
- `https://tu-app.onrender.com/NCode/` - Página principal
- `https://tu-app.onrender.com/NCode/login` - Login
- `https://tu-app.onrender.com/NCode/planes` - Planes
